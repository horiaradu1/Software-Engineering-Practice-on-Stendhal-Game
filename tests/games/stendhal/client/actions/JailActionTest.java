	...
	public void testExecute() {
		new MockStendhalClient() {
			...
			public void send(final RPAction action) {
				...
				assertEquals("woooo amaze", action.get("reason"));
			}
		};
		final SlashAction action = SlashActionRepository.get("jail");
		assertFalse(action.execute(new String []{"kash", "30"}, ""));
		assertTrue(action.execute(new String []{"kash", "30"}, "woooo amaze"));
	}
